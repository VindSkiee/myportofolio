...
export default {
  ...
  theme: {
    extend: {
      ...
      // GRADIENT PRESETS - INSIDE extend to preserve Tailwind defaults
      backgroundImage: {
        ...
        'shimmer-prismatic-sync':
          'linear-gradient(90deg, #0d9488 0%, #14b8a6 15%, #06b6d4 30%, rgba(255,255,255,0.95) 50%, #22d3ee 70%, #38bdf8 85%, #0d9488 100%)',
      },
    },
  },
  plugins: [],

...
const skills = [
  ...
  {
    category: "Backend",
    items: ["Node.js", "PHP", "Express", "Laravel", "Go", "Python", "MongoDB", "MySQL", "PostgreSQL", "Prisma", "Drizzle", "Redis"],
  },
  {
    category: "Tools & Others",
    items: ["Git", "Docker", "Figma", "AWS", "Vercel", "CI/CD", "Supabase", "Firebase", "Midtrans", "Gemini API"],
  },
];
